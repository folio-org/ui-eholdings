...
@page class CustomerResourceEditPage {
  ...
  name = fillable('[data-test-eholdings-customer-resource-name-field] input');
  nameHasError = hasClassBeginningWith('feedbackError--', '[data-test-eholdings-customer-resource-name-field] input');
