...
describeApplication('ManagedResourceEditProxy', () => {
  ...
  describe('visiting the resource edit page with an inherited proxy', () => {
    ...
    it('displays the select name as proxy prepended with Inherited', () => {
      expect(ResourceEditPage.proxySelectText).to.include('Inherited');
      expect(ResourceEditPage.proxySelectText).to.include('bigTestJS');
    });
