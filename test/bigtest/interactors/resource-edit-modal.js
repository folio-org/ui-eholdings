...
export default @interactor class ResourceEditModal {
  ...
  confirmDeselection = clickable('[data-test-eholdings-deselection-confirmation-modal-yes]');
  cancelDeselection = clickable('[data-test-eholdings-resource-deselection-confirmation-modal-no]');
  confirmButtonText = text('[data-test-eholdings-deselection-confirmation-modal-yes]');
  confirmButtonIsDisabled = property('[data-test-eholdings-deselection-confirmation-modal-yes]', 'disabled');
}
