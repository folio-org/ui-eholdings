...
@interactor class ProviderShowPage {
  ...
  token = text('[data-test-eholdings-details-token]');
  tokenMessage = text('[data-test-eholdings-details-token-message]');
  isTokenPresent = isPresent('[data-test-eholdings-details-token]');
  toast = Toast;
