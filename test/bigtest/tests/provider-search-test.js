...
describe('ProviderSearch searching for a provider clicking a search results list item clicking an item within the preview pane and clicking the back button', () => {
  setupApplication({
    scenarios: ['providerSearch']
  });
...
describe('ProviderSearch searching for a provider clicking a search results list item conducting a new search', () => {
  setupApplication({
    scenarios: ['providerSearch']
  });
...
describe('ProviderSearch with multiple pages of providers searching for providers', () => {
  setupApplication({
...
describe('ProviderSearch with multiple pages of providers searching for providersand then scrolling down', () => {
  setupApplication({
    scenarios: ['providerSearchMultipleProviderPages']
  });
  ...
  beforeEach(async function () {
    ...
    await ProviderSearchPage.scrollToOffset(26);
  });
...
describe('ProviderSearch with multiple pages of providers navigating directly to a search page and then scrolling up', () => {
  setupApplication({
    scenarios: ['providerSearchMultipleProviderPages']
  });
...
describe('ProviderSearch filtering providers by tags clicking to open tags accordion', () => {
  setupApplication({
    scenarios: ['providerSearchFilteringByTags']
  });
...
describe('ProviderSearch filtering providers by tags clicking to open tags accordion and search by tags was enabled', () => {
  setupApplication({
    scenarios: ['providerSearchFilteringByTags']
  });
...
describe('ProviderSearch filtering by tags, open tags accordion, search by tags urgent option', () => {
  setupApplication({
    scenarios: ['providerSearchFilteringByTags']
  });
...
describe('ProviderSearch filtering by tags, open tags accordion, search by tags urgent option, after click on non urgent option', () => {
  setupApplication({
    scenarios: ['providerSearchFilteringByTags']
  });
...
describe('ProviderSearch filtering by tags, open tags accordion, search by tags urgent option, after click on non urgent option and removing not urgent tag filter', () => {
  setupApplication({
    scenarios: ['providerSearchFilteringByTags']
  });
...
describe('ProviderSearch filtering by tags, open tags accordion, search by tags urgent option, after click on non urgent option and removing not urgent tag filter clearing the filters', () => {
  setupApplication({
    scenarios: ['providerSearchFilteringByTags']
  });
...
describe('ProviderSearch sorting providers searching for providers and then filtering by sort options', () => {
  setupApplication({
...
describe('ProviderSearch sorting providers searching for providers and then filtering by sort options then searching for other providers then clicking another search type', () => {
  setupApplication({
    scenarios: ['providerSearchSorting']
  });
...
describe('ProviderSearch sorting providers searching for providers and then filtering by sort options then searching for other providers then clicking another search type navigating back to providers search', () => {
  setupApplication({
    scenarios: ['providerSearchSorting']
  });
...
describe('ProviderSearch sorting providers clearing the search field', () => {
  setupApplication({
    scenarios: ['providerSearchSorting']
  });
...
describe('ProviderSearch sorting providers selecting a filter without a value in the search field', () => {
  setupApplication({
    scenarios: ['providerSearchSorting']
  });
...
describe('ProviderSearch sorting providers searching for providers', () => {
  setupApplication({
    scenarios: ['providerSearchSorting']
  });
