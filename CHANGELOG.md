...
* Change package type facet to searchable selection, and use all filters for search regardless of query presence (UIEH-1527)
* Add package access filter to package search and provider package search. (UIEH-1527)
...
* eHoldings Package record titlelist: Add Results list column chooser to Search within Actions button menu. (UIEH-1455)
